...
-- CreateIndex
CREATE INDEX "Pin_title_idx" ON "Pin"("title");
...
-- AddForeignKey
ALTER TABLE "PinUserLikes" ADD CONSTRAINT "PinUserLikes_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PinUserLikes" ADD CONSTRAINT "PinUserLikes_pinId_fkey" FOREIGN KEY ("pinId") REFERENCES "Pin"("id") ON DELETE CASCADE ON UPDATE CASCADE;
